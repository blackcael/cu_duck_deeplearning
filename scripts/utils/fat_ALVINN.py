...
class fat_ALVINN_LAYER(nn.Module):
...
class fat_ALVINN(nn.Module):
    def __init__(self, imagesize_hw = (INPUT_SIZE_H, INPUT_SIZE_W)):
        super().__init__()
        h, w = imagesize_hw
        self.net = nn.Sequential(
            fat_ALVINN_LAYER(h * w, HIDDEN_UNITS),
            fat_ALVINN_LAYER(HIDDEN_UNITS, HIDDEN_UNITS),
            fat_ALVINN_LAYER(HIDDEN_UNITS, HIDDEN_UNITS),
            fat_ALVINN_LAYER(HIDDEN_UNITS, HIDDEN_UNITS),
            fat_ALVINN_LAYER(HIDDEN_UNITS, OUTPUT_LAYER_SIZE)
        )
